 ...
 *
 * @param tol Minimum distance before we clamp the result to zero.
 ...
 */
real3_t compute_filament_induction(real_t tol, real3_t r1, real3_t r2, real3_t direction, real3_t control_point);
